...
class GroqProvider(BaseLLMProvider):
    def __init__(self, model: str = "llama-3.1-70b-versatile", api_key: str | None = None):
        super().__init__(ProviderSpec(name="groq", max_context_tokens=131_072))
        self.model = model
    ...
    async def extract_structured(self, prompt: str, schema_hint: str) -> str:
        ...
        if resp.status_code == 429:
            ...
            raise RateLimitError("groq rate limited", retry_after=float(retry_after) if retry_after else None)
